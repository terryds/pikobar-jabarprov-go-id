<template>
  ...
  >
    <div class="lg:order-2 lg:w-full flex items-center text-green-500">
      <FontAwesomeIcon
        class="mr-3 text-2xl pointer-events-none"
        :icon="icon.faPhoneAlt"
      />
      <label class="hidden text-xl lg:inline-block font-bold ml-3">
        {{ number }}
      </label>
    </div>
    <div class="pointer-events-none text-gray-900 lg:order-1 lg:mb-4">
