<template>
  <div class="container mx-auto">
    ...
    <div class="">
      <section
        class="bg-white mx-4 my-8"
        style="border-radius: 0.8rem; box-shadow: 0 0 4px 0px rgba(0,0,0,0.05), 0 4px 24px 0 rgba(0,0,0,0.1);">
        <h2 class="px-5 pt-5 text-xl font-bold leading-tight">
